...
_wctl() {
    ...
    local commands="list focused info workspaces monitors workarea activate focus wait move resize move-resize place tile center resolve-place workspace move-to-workspace move-to-monitor minimize unminimize maximize unmaximize fullscreen unfullscreen above sticky close help completion"
    ...
    case "$cmd" in
        list)
            ...
            ;;
        focused|workspaces|monitors|workarea)
